...
import { ThemeProvider as NextThemesProvider } from '@repo/ui/base'
...
export function DropdownMenuThemeRadio({
  ...
  if (!isMounted) {
    return skeleton ?? <div className={buttonVariants({ className: 'pointer-events-none', size: 'icon', variant: 'outline' })} />
  }
