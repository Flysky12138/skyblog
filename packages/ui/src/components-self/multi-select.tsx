...
import { Draft, useImmer } from '@repo/react-hooks'
          ...
          <>
            <div className="flex grow flex-wrap items-center gap-2">
              {selectedValues.map(option => (
                <Badge
                  key={getValue(option)}
                  className="rounded-sm border-foreground/10 bg-secondary text-secondary-foreground hover:bg-secondary/80"
                >
            ...
            <div className="flex items-center justify-between">
              <div
                ...
                className="ring-default mx-2 flex size-4 cursor-pointer items-center justify-center rounded-sm text-muted-foreground hover:text-foreground"
                role="button"
                tabIndex={0}
                onClick={event => {
                  event.stopPropagation()
