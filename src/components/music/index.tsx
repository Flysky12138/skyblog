    ...
    >
      ...
      <AnimatePresence initial={false} mode="wait">
        ...
        >
          ...
          {/* 歌词 */}
          <MusicLyric ref={lyricRef} className="absolute inset-x-0 bottom-0" value={currentLyric} />
        </motion.div>
      </AnimatePresence>
      <div className="px-5 py-4">
        ...
        <div className="mt-3 grid grid-cols-3 items-center">
          ...
          <div className="space-x-2 justify-self-end">
            ...
            {/* 播放列表 */}
            <MusicPlaylist activeIndex={player.index} value={player.list} onClick={value => dispatch({ payload: value, type: 'playIndex' })} />
          </div>
        </div>
      </div>
    </section>
