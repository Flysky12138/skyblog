...
export const Code = ({ children, className, style = {}, ...props }: React.ComponentProps<'code'>) => {
  // pre > code
  const codeRef = React.useRef<HTMLElement>(null)
  if (Reflect.has(props, DATA_IS_BLOCK)) {
    ...
    return (
      <code
        ...
        className={cn(
          'group aria-[expanded="false"]:h-(--max-h) aria-[expanded="false"]:overflow-hidden',
          {
