      ...
      <svg className="h-2/3 w-2/3 lg:h-1/2 lg:w-1/2" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
        <g>
          ...
          <path
            ...
            fill="#ebebeb"
          ></path>
          <path d="M206.71 98.4a1.33 1.33 0 11-1.33-1.33 1.34 1.34 0 011.33 1.33z" fill="#f5f5f5"></path>
          <circle cx="207.14" cy="415.38" fill="#f0f0f0" r="7.35" transform="rotate(-13.28 207.178 415.437)"></circle>
          <path d="M204.6 411.09a7.09 7.09 0 00-4.19 1.36 7.34 7.34 0 0010.5 9.23 7.17 7.17 0 00-6.31-10.58z" fill="#e6e6e6"></path>
        </g>
        <g fill="#407BFF">
        ...
        <g>
          ...
          <circle cx="141.23" cy="116.36" fill="#407BFF" r="21.91"></circle>
          <circle cx="141.23" cy="116.36" fill="#fff" opacity="0.7" r="21.91"></circle>
          <path d="M133.68 99.83a21.84 21.84 0 00-8.68 1.77 21.92 21.92 0 0024.87 34.89 21.92 21.92 0 00-16.23-36.65z" fill="#407BFF" opacity="0.2"></path>
          <path
            ...
            opacity="0.2"
          ></path>
          <circle cx="382.2" cy="376.25" fill="#407BFF" r="19.23" transform="rotate(-76.72 382.179 376.25)"></circle>
          <circle cx="382.2" cy="376.25" fill="#fff" opacity="0.3" r="19.23" transform="rotate(-76.72 382.179 376.25)"></circle>
          <path d="M394.33 361.34a19.22 19.22 0 00-17.67 33.32 19 19 0 005.53.82 19.23 19.23 0 0012.14-34.14z" fill="#407BFF" opacity="0.4"></path>
          <path d="M363.83 382c-20.53 9.66-5.22 17.11 23.71 6.71 26.79-9.63 37-21.77 13-18 1.29 5.05-32.26 18.12-36.71 11.29z" fill="#407BFF"></path>
        </g>
        <g>
          <path d="M394.1 187.83C367.21 206 332.4 230 322.79 287.64h-2.05c9.35-57 42.89-81.57 69.79-99.81z" opacity="0.2"></path>
          <path
          ...
          <path
            ...
            opacity="0.2"
          ></path>
          <path d="M312.76 97a46.05 46.05 0 0113.58 2.13s11 18.77 12.3 23.07c-.46 4.24-7.61 11.19-7.61 11.19z" fill="#407BFF"></path>
        ...
        <g>
          ...
          <path
            ...
            opacity="0.6"
          ></path>
          <circle cx="222.2" cy="282.18" fill="#fff" r="12.9"></circle>
          <circle cx="222.2" cy="282.18" fill="#407BFF" r="8.29"></circle>
