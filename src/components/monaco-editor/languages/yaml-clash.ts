import schema from '@/assets/schema/meta-json-schema.json'
...
export const yamlClashConfig: LanguageConfig = {
  ...
  registerEvents: monaco => [
    ...
    configureMonacoYaml(monaco, {
      schemas: [{ fileMatch: ['*'], schema: schema as unknown as JSONSchema, uri: 'monaco://schemas/meta-json-schema.json' }]
    })
  ]
}
