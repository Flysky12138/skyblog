...
import {
  DefaultPostType,
  MessageEventDataMounted,
  MessageEventDataRefresh,
...
export default function Page() {
  ...
  const { postMessage } = useBroadcastChannel<MessageEventDataRefresh, MessageEventDataMounted>(
    POST_PREVIEW_BROADCAST_CHANNEL_ID,
    ({ type, value }) => {
      if (type != 'post-refresh') return
      setPost(value)
    }
  )
