...
import { DEFAULT_POST, DefaultPostType, MessageEventDataMounted, MessageEventDataRefresh, POST_PREVIEW_BROADCAST_CHANNEL_ID } from './utils'
...
export default function Page({ params }: PageProps<'/dashboard/posts/[id]'>) {
  ...
  const { postMessage } = useBroadcastChannel<MessageEventDataMounted, MessageEventDataRefresh>(
